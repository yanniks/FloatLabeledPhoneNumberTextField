...
open class FloatLabeledPhoneNumberTextField: JVFloatLabeledTextField, UITextFieldDelegate {
...
//            self.partialFormatter.withPrefix = self.withPrefix
    ...
    open func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
        ...
        let filteredCharacters = modifiedTextField.filter {
            String($0).rangeOfCharacter(from: (textField as! FloatLabeledPhoneNumberTextField).nonNumericSet as CharacterSet) == nil
        }
...
@available(iOS 11.0, *)
extension FloatLabeledPhoneNumberTextField: CountryCodePickerDelegate {
